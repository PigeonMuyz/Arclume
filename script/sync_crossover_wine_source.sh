...
CACHE_DIR="$RUNTIME_SOURCE_DIR/cache"
PATCH_DIR="$RUNTIME_SOURCE_DIR/patches"
...
its SHA-256, extracts sources/wine into RuntimeSource/wine, and applies tracked
